...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            String encryptedDirPath = currentDirPath + File.separator + "src" + File.separator + "S1_05" + File.separator + "S1_05_encrypted";
            String decryptedDirPath = currentDirPath + File.separator + "src" + File.separator + "S1_05" + File.separator + "S1_05_decrypted";
